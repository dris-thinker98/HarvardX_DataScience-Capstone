...
packages.list <-  c('pacman', 'plyr', 'png',
                    'RColorBrewer', 'recosystem', 'rlang', 'rmarkdown',
                    'skimr','anytime',
                    'gsubfn', 'ggvis',
                    'kableExtra', 'knitr',
                    'magrittr', 'matrixStats',
                    'tidyverse','caret', 'caretEnsemble', 'cluster',
                    'data.table',
                    'factoextra', 'fpc')
...
#Validation: if files have been loaded previously
...
# --------------Total of new fields obtained by splitted genres------------------

new.fields.amount <- length(edx.test$movieId) - length(edx$movieId)
new.fields.amount

#Removal of unrequired variables
rm(packages.list)

#---------------------Count of different users & movies------------------------

users.movies <- edx.test %>%
  dplyr::summarize(Users = n_distinct(userId),
                   Movies = n_distinct(movieId))
table(users.movies,
      'Count of distinct Users & Movies')

#Structure of edx.test dataset, when genres are more than one
str(edx.test)

# Dimension of edx.test dataset
dim(edx.test)
...
#Total ratings per genre, over the years
...
#Years where movies were count of ratings were high or low
...
#............< Movie titles with most/least Ratings >..........................
...
#...............< Most Successful Movie Titles per Year>......................
...
# Users rated movies with 4.0 more than quarter of the time.
...
#..................Prediction of largest errors in edx.test data frame..........................
...
#No. of times the 10 best movies have been rated
...
#No. of times the 10 top worst movies have been rated
...
#Adding lamda for movies that have been rated few times
...
#Top 10 best movies after regularization procedure
...
#We need to identify the best lambda *from 0 to 7 at sequence of 0.2), over the movies bias
#the lowest value needs to be chosen
